package org.firstinspires.ftc.teamcode.auto.follower;

import static org.firstinspires.ftc.teamcode.auto.tuning.FollowerConstants.drivePIDFFeedForward;
import static org.firstinspires.ftc.teamcode.auto.tuning.FollowerConstants.drivePIDFSwitch;
import static org.firstinspires.ftc.teamcode.auto.tuning.FollowerConstants.forwardZeroPowerAcceleration;
import static org.firstinspires.ftc.teamcode.auto.tuning.FollowerConstants.headingPIDFFeedForward;
import static org.firstinspires.ftc.teamcode.auto.tuning.FollowerConstants.headingPIDFSwitch;
import static org.firstinspires.ftc.teamcode.auto.tuning.FollowerConstants.lateralZeroPowerAcceleration;
import static org.firstinspires.ftc.teamcode.auto.tuning.FollowerConstants.leftFrontMotorName;
import static org.firstinspires.ftc.teamcode.auto.tuning.FollowerConstants.leftRearMotorName;
import static org.firstinspires.ftc.teamcode.auto.tuning.FollowerConstants.rightFrontMotorName;
import static org.firstinspires.ftc.teamcode.auto.tuning.FollowerConstants.rightRearMotorName;
import static org.firstinspires.ftc.teamcode.auto.tuning.FollowerConstants.leftFrontMotorDirection;
import static org.firstinspires.ftc.teamcode.auto.tuning.FollowerConstants.leftRearMotorDirection;
import static org.firstinspires.ftc.teamcode.auto.tuning.FollowerConstants.rightFrontMotorDirection;
import static org.firstinspires.ftc.teamcode.auto.tuning.FollowerConstants.rightRearMotorDirection;
import static org.firstinspires.ftc.teamcode.auto.tuning.FollowerConstants.secondaryDrivePIDFFeedForward;
import static org.firstinspires.ftc.teamcode.auto.tuning.FollowerConstants.secondaryHeadingPIDFFeedForward;
import static org.firstinspires.ftc.teamcode.auto.tuning.FollowerConstants.secondaryTranslationalPIDFFeedForward;
import static org.firstinspires.ftc.teamcode.auto.tuning.FollowerConstants.translationalPIDFFeedForward;
import static org.firstinspires.ftc.teamcode.auto.tuning.FollowerConstants.translationalPIDFSwitch;
import static org.firstinspires.ftc.teamcode.auto.tuning.FollowerConstants.useSecondaryDrivePID;
import static org.firstinspires.ftc.teamcode.auto.tuning.FollowerConstants.useSecondaryHeadingPID;
import static org.firstinspires.ftc.teamcode.auto.tuning.FollowerConstants.useSecondaryTranslationalPID;
...
import org.firstinspires.ftc.teamcode.auto.localization.Localizer;
import org.firstinspires.ftc.teamcode.auto.localization.Pose;
import org.firstinspires.ftc.teamcode.auto.localization.PoseUpdater;
import org.firstinspires.ftc.teamcode.auto.pathGeneration.BezierPoint;
import org.firstinspires.ftc.teamcode.auto.pathGeneration.MathFunctions;
import org.firstinspires.ftc.teamcode.auto.pathGeneration.Path;
import org.firstinspires.ftc.teamcode.auto.pathGeneration.PathBuilder;
import org.firstinspires.ftc.teamcode.auto.pathGeneration.PathCallback;
import org.firstinspires.ftc.teamcode.auto.pathGeneration.PathChain;
import org.firstinspires.ftc.teamcode.auto.pathGeneration.Point;
import org.firstinspires.ftc.teamcode.auto.pathGeneration.Vector;
import org.firstinspires.ftc.teamcode.auto.tuning.FollowerConstants;
import org.firstinspires.ftc.teamcode.auto.util.DashboardPoseTracker;
import org.firstinspires.ftc.teamcode.auto.util.Drawing;
import org.firstinspires.ftc.teamcode.auto.util.FilteredPIDFController;
import org.firstinspires.ftc.teamcode.auto.util.KalmanFilter;
import org.firstinspires.ftc.teamcode.auto.util.PIDFController;
...
public class Follower {
    ...
    public double getDriveVelocityError() {
        ...
        if (forwardDistanceToGoal < 0 && forwardZeroPowerAcceleration > 0) forwardZeroPowerAcceleration *= -1;
        if (forwardDistanceToGoal > 0 && forwardZeroPowerAcceleration < 0) forwardZeroPowerAcceleration *= -1;
...
//        if (lateralDistanceToGoal < 0 && lateralZeroPowerAcceleration > 0) lateralZeroPowerAcceleration *= -1;
//        if (lateralDistanceToGoal > 0 && lateralZeroPowerAcceleration < 0) lateralZeroPowerAcceleration *= -1;
