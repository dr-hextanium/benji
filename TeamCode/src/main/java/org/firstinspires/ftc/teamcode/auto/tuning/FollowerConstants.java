...
import org.firstinspires.ftc.teamcode.auto.util.CustomFilteredPIDFCoefficients;
import org.firstinspires.ftc.teamcode.auto.util.CustomPIDFCoefficients;
import org.firstinspires.ftc.teamcode.auto.util.KalmanFilterParameters;
...
public class FollowerConstants {
    ...
    private static double xMovement = 70.5;
    private static double yMovement = 49.5;
    ...
    public static double drivePIDFFeedForward = 0.015;
    ...
    public static double forwardZeroPowerAcceleration = -36.6;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -72.95;
    ...
    public static double zeroPowerAccelerationMultiplier = 0.5;
    ...
    public static double headingPIDFSwitch = 0.3;
